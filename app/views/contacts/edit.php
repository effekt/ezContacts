          <form method="post" enctype="multipart/form-data" action="<?=BASE_PATH;?>/contacts/edit/<?=$data->id;?>">
            <div class="row">
              <div class="col-sm-12">
            ...
            <div class="row">
              <div class="col-sm-12">
                <div class="form-group">
                  <button type="submit" class="btn btn-primary btn-lg btn-block">Edit Contact!</button>
                </div>
              </div>
            </div>
          </form>
